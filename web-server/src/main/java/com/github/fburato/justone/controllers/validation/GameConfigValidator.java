...
public class GameConfigValidator implements EntityValidator.Validator<GameConfig> {
    ...
    private static Validation<Seq<String>, List<String>> nonEmptyList(List<String> content, String fieldName) {
        if (content == null) {
    ...
    private static Validation<Seq<String>, String> notBlankStrippedString(String value, String fieldName) {
